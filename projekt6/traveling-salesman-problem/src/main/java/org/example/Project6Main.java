...
public class Project6Main {
    ...
    public static void main(String[] args) {
        ...
        List<QuadAlgorithmEntry> algorithms = List.of(
                new QuadAlgorithmEntry("HAE", (inst, matrix, rng, startSolution) -> {
                    return new HybridEvolutionaryAlgorithm(200*avgMSLSTime, matrix, rng).run(inst);
                })
        ...
        for (QuadAlgorithmEntry entry : algorithms) {
            ...
            for (int i = 0; i < numRuns; i++) {
                ...
                Solution randomStartSolution = new WeightedRegretHeuristicAlgorithm(1,-1).solve(instance, distanceMatrix, rng);
